  ...
  return (
    ...
    <Screen edges={["left", "right"]}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {user && configured ? <VerifiedEmailsSection primaryEmail={user.email} /> : null}
...
/**
 * Claim a reachable address when Apple supplied a private-relay address.
 ...
 */
function VerifiedEmailsSection({ primaryEmail }: { readonly primaryEmail: string | null }) {
  ...
  return (
    <Card>
      <Text style={styles.sectionLabel}>Verified emails</Text>
      <MutedText>
        Signed in with Apple Hide My Email? Add the address your organiser or co-host invitation was
        sent to. Verifying it can unlock that invitation without changing your sign-in email.
      </MutedText>

      {primaryEmail ? <Row label="Sign-in email" value={primaryEmail} /> : null}
